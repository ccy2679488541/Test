...
public class KiannaEntityModel extends EntityModel<KiannaEntity> {
    ...
    public KiannaEntityModel() {
        ...
        left_leg.setTexSize(64, 128).addBox(-4.0F, -12.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

        left_arm = new ModelRenderer(this);
        left_arm.setPos(0.0F, 24.0F, 0.0F);
        left_arm.setTexSize(128, 0).addBox(-8.0F, -24.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

        body = new ModelRenderer(this);
        body.setPos(0.0F, 24.0F, 0.0F);
        body.setTexSize(0, 60).addBox(-4.0F, -24.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.0F, false);

        right_arm = new ModelRenderer(this);
        right_arm.setPos(0.0F, 24.0F, 0.0F);
        right_arm.setTexSize(0, 128).addBox(4.0F, -24.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);

        right_leg = new ModelRenderer(this);
        right_leg.setPos(0.0F, 24.0F, 0.0F);
        right_leg.setTexSize(96, 64).addBox(0.0F, -12.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);
    }
